...
lesson_texts = {
    "intro_0": """🤖 Ознакомление с ботом

Добро пожаловать в бот «Бизнес с Китаем»!

Этот бот создан для обучения закупкам товаров из Китая.

Здесь вы сможете изучить:

• Обзор китайских площадок
• Регистрацию и настройку аккаунтов
• Настройку доставки и добавление адреса карго
• Поиск товаров
• Работу с фабриками и поставщиками
• Оформление и оплату заказов
• Возврат и отмену заказов
• Карго и логистику
• Полезные инструменты для работы

📚 Обучение разделено на бесплатные и Premium-разделы.

🟢 Первая часть обучения доступна бесплатно всем пользователям.

🔒 Для получения доступа ко всем разделам и дополнительным материалам необходимо оформить Premium-подписку.

Такой подход позволяет начать обучение без вложений и ознакомиться с основными принципами закупок товаров из Китая.

Для начала обучения перейдите в раздел «Обучение» и выберите интересующую тему.

Желаем успешных закупок и развития вашего бизнеса!""",

    "intro_1": """🎓 Ознакомление с обучением
...
2️⃣ 🔎 Обзор китайских площадок

3️⃣ 👤 Регистрация и настройка аккаунтов

4️⃣ 🚚 Настройка доставки

5️⃣ 📦 Поиск товара

6️⃣ 🏭 Работа с фабриками и поставщиками

7️⃣ 📝 Как оформить заказ

8️⃣ ↩️ Возврат и отмена заказа

9️⃣ 🚛 Карго и логистика

🔟 🛠 Полезные инструменты

После прохождения обучения вы сможете:

✅ Самостоятельно искать товары в Китае

✅ Общаться с поставщиками и фабриками

✅ Проверять продавцов перед покупкой

✅ Оформлять и оплачивать заказы

✅ Отменять заказы и оформлять возвраты при необходимости

✅ Работать с карго-доставкой и понимать её особенности

✅ Организовывать закупки для себя или для бизнеса

Необязательно изучать всё сразу.

Начните с первых разделов и постепенно переходите к следующим урокам.
